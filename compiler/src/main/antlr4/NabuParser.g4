...
functionHeader
    : 'fun' (typeParameters annotation*)? functionDeclarator (':' result) throwsT?
    ;
...
formalParameter
    : variableModifier* variableDeclaratorId ':' unannType
...
explicitConstructorInvocation
    : typeArguments? name=('this' | 'super') '(' argumentList? ')' ';'
    | (expressionName | primary) '.' typeArguments? name='super' '(' argumentList? ')' ';'
    ;
...
lambdaParameter
    : variableModifier* variableDeclaratorId ':' lambdaParameterType
    | variableArityParameter
    ;
