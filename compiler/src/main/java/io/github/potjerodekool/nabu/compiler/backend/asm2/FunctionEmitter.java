...
public class FunctionEmitter {
    ...
    private final Asm2ByteCodeEmitter codeEmitter;
    ...
    public FunctionEmitter(final MethodVisitor methodVisitor,
                           final Asm2ByteCodeEmitter codeEmitter,
    ...
    private void emitLoad(final IRInstruction.Load load) {
        ...
        if (ptr instanceof IRValue.Named named) {
            ...
            final var opcode = resolveLoadOpcode(temp.type());
    ...
    private int resolveReturnOpcode(final IRType type) {
        return switch (type) {
            ...
            case IRType.Ptr ptr -> {
                if (ptr.jvmDescriptor() != null) {
                    yield resolveReturnOpcodeFromDescriptor(ptr.jvmDescriptor());
                }
