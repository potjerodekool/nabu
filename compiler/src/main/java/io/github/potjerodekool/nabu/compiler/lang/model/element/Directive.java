...
public abstract class Directive implements ModuleElement.Directive {
    ...
    public static class RequiresDirective extends Directive implements ModuleElement.RequiresDirective {
        ...
        private final Set<Directive.RequiresFlag> flags;
        ...
        public RequiresDirective(final ModuleElement module,
                                 final Set<Directive.RequiresFlag> flags) {
            super(ModuleElement.DirectiveKind.REQUIRES);
            this.module = module;
            this.flags = flags;
        }

        private boolean hasFlag(final Directive.RequiresFlag flag) {
            return flags.contains(flag);
        }

        @Override
        public boolean isStatic() {
            return hasFlag(Directive.RequiresFlag.STATIC_PHASE);
        }

        @Override
        public boolean isTransitive() {
            return hasFlag(Directive.RequiresFlag.TRANSITIVE);
        }
        ...
        public Set<Directive.RequiresFlag> getFlags() {
            return flags;
        }
    ...
    public static class ExportsDirective extends Directive implements ModuleElement.ExportsDirective {
        ...
        private final Set<Directive.ExportsFlag> flags;

        public ExportsDirective(final PackageElement packageSymbol,
                                final List<ModuleElement> modules) {
            this(packageSymbol, modules, EnumSet.noneOf(Directive.ExportsFlag.class));
        }

        public ExportsDirective(final PackageElement packageSymbol,
                                final List<ModuleElement> modules,
                                final Set<Directive.ExportsFlag> flags) {
        ...
        public Set<Directive.ExportsFlag> getFlags() {
            return flags;
        }
    }
    ...
    public static class OpensDirective extends Directive implements ModuleElement.OpensDirective {
        ...
        private final PackageElement packageSymbol;
        private final List<ModuleElement> modules;
        private final Set<Directive.OpensFlag> flags;

        public OpensDirective(final PackageElement packageSymbol,
                              final List<ModuleElement> modules) {
            this(packageSymbol, modules, EnumSet.noneOf(Directive.OpensFlag.class));
        }

        public OpensDirective(final PackageElement packageSymbol,
                              final List<ModuleElement> modules,
                              final Set<Directive.OpensFlag> flags) {
        ...
        public Set<Directive.OpensFlag> getFlags() {
            return flags;
        }
    }
