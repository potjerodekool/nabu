 ...
 * Needed since the type of array in an annotation isn't known when parsing a class file.
 */
public class AnnotationDeProxyProcessorImpl extends AbstractAnnotationValueVisitor<Attribute, ExecutableElement> {
