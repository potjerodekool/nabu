...
public class CLambdaExpressionTree extends CExpressionTree implements LambdaExpressionTree {
    ...
    private final List<Tree> variables = new ArrayList<>();
    ...
    public CLambdaExpressionTree(final List<Tree> parameters,
                                 final Tree body,
    ...
    private ParameterKind resolveParameterKind(final List<Tree> parameters) {
        return parameters.isEmpty() || parameters.getFirst() instanceof VariableDeclaratorTree ? ParameterKind.EXPLICIT : ParameterKind.IMPLICIT;
    }
    ...
    public CLambdaExpressionTree variable(final ExpressionTree variable) {
