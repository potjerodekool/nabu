...
/**
 * @deprecated Replaced by JpaTransformer which doesn't use an element resolver.
 * Transform JPA dsl to normal code.
 */
@Deprecated(forRemoval = true)
public class JpaTransformerClassic extends AbstractTreeVisitor<Object, Scope> implements CodeTransformer {
    ...
    public JpaTransformerClassic(final CompilerContext compilerContext) {
